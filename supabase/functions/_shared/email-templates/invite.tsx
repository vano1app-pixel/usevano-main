...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join VANO</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="VANO" width="48" height="48" style={logo} />
        <Heading style={h1}>You're invited! 🎉</Heading>
        <Text style={text}>
          Someone wants you on VANO — Galway's local gig marketplace. Accept below to create your account and jump in.
        </Text>
