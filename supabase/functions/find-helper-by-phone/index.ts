...
const PROFILE_COLUMNS =
  'id, name, phone, photo_url, city, bio, categories, availability, status, stripe_account_id, stripe_payouts_enabled, student_email_verified, id_verified, verified_plan_active, vano_verified';
