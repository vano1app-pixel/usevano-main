            ...
            >
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="mt-3 flex items-center gap-2 bg-[#25D366] text-white text-sm font-bold px-4 py-2.5 rounded-xl w-fit active:scale-[0.97] transition-transform"
                >
                  ...
                  Confirm my booking on WhatsApp
                </a>
              </div>
            </motion.div>
          )}
