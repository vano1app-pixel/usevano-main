            ...
            <form onSubmit={handleLookup} className="mt-5 flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-background pl-10 pr-4 py-2.5 text-base sm:text-sm placeholder:text-muted-foreground/40 focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent"
                />
              </div>
              <button
                type="submit"
                disabled={!input.trim()}
                className="btn-gold flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold text-navy disabled:opacity-40 transition-transform duration-150 active:scale-[0.97]"
              >
                Find
              </button>
            </form>
