...
const CATEGORIES: Category[] = [
  {
    ...
    description: 'We shop any store, follow your list exactly, and deliver straight to your door — groceries, pharmacy, any errand.',
    sizeLabel: 'What kind?',
  ...
  },
  {
    ...
    description: 'Your dog is collected from your door, walked on-lead for the time you choose, and returned home safely.',
    sizeLabel: 'How long?',
  ...
  },
  {
    ...
    description: 'Mowing, weeding, edging and tidying — all waste bagged and left for collection.',
    sizeLabel: 'How long?',
  ...
  },
  {
    ...
    description: 'Hoovering, mopping, surfaces, kitchen and bathroom — a proper clean using whatever products you have.',
    sizeLabel: 'How long?',
  ...
  },
  {
    ...
    description: 'One-to-one at your home or nearby. Any subject — Maths, science, languages, essay help. Junior Cert to college level.',
    sizeLabel: 'How long?',
    sizes: ['1 hour', '2 hours', '3 hours'],
  },
];
