...
const STEPS = [
  {
    ...
    body: 'Choose a category and pick a time. Price shown upfront — and you pay nothing yet.',
  },
  {
    n: '2',
    title: 'Helper accepts — then you pay',
    body: 'A verified student nearby accepts. You see their name, photo and rating, then pay securely by card.',
  },
  {
    n: '3',
