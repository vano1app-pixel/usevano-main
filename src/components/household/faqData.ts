/**
 * FAQ content — shared by the on-page FAQSection and the FAQPage
 * JSON-LD on HouseholdHome. The schema must always match what's
 * visibly on the page, so both import from here.
 */
export const FAQS = [
  {
