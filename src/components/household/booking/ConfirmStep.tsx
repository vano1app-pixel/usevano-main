...
import { Loader2, Lock, ChevronRight, LocateFixed, MapPin } from 'lucide-react';
...
const AddressPicker: React.FC<AddressPickerProps> = ({ value, coords, error, onAddress, onBlur }) => {
