...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        // text-base below md, text-sm on md+ — matches the Input
        // primitive's pattern. Anything under 16px on iOS Safari
        // auto-zooms the viewport on focus; keeping mobile at 16px
        // avoids the zoom without the desktop text-sm density hit.
